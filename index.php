...
/* Required settings     */
$HCSET['OFFER_PAGE'] = 'index1.php';//PHP/HTML file or URL offer used for real users
$HCSET['WHITE_PAGE'] = 'data.php';//PHP/HTML file or URL used for bots
...
$HCSET['FILTER_REF_LIST'] = 'google'; // 'regExp()';
$HCSET['FILTER_NOREF'] = 'allow'; // 'allow|reject';
...
$HCSET['API_SECRET_KEY'] = 'v186e717037fa6479ba27787ccc11ee903';
/*********************************************/
...
function apiRequest($ip, $port, $HCSET, $HCSETdata)
{
    ...
    $url = 'http://'.$host.'/basic?ip=' . $ip . '&port=' . $port . '&key=' . $HCSET['API_SECRET_KEY'] . '&sign=v2-286269518&js=false&stage='.$HCSET['stage'];
